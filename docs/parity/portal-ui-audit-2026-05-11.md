...
| `cave-alerts` | ✓ | Alertmanager UI | [link](https://prometheus.io/docs/alerting/latest/clients/) | `partial` | 108 | P1 | Active alerts, silences |
...
| `cave-artifacts` | ✓ | Pulp Web UI | [link](https://pulpproject.org/) | `partial` | 88 | P1 | Repository browser |
| `cave-auth` | ✓ | Keycloak Admin Console | [link](https://www.keycloak.org/documentation) | `scaffold` | 75 | P1 | Realm / client / user management |
| `cave-backup` | ✓ | Velero (limited UI) | [link](https://velero.io/) | `partial` | 105 | P2 | Mostly CLI |
| `cave-cache` | ✓ | RedisInsight (external) | [link](https://redis.io/insight/) | `partial` | 196 | P0 | Key explorer, slow-log |
...
| `cave-chaos` | ✓ | Chaos Dashboard | [link](https://chaos-mesh.org/docs/) | `partial` | 94 | P1 | Experiment timeline |
...
| `cave-crm` | ✓ | Twenty CRM | [link](https://twenty.com/) | `scaffold` | 75 | P1 | Full CRM React app |
...
| `cave-erp` | ✓ | ERPNext | [link](https://erpnext.com/) | `scaffold` | 75 | P1 | Full ERP UI |
...
| `cave-rollouts` | ✓ | Argo Rollouts UI | [link](https://argo-rollouts.readthedocs.io/en/stable/dashboard/) | `scaffold` | 75 | P1 | Canary progress |
| `cave-sbom` | ✓ | Dependency-Track | [link](https://dependencytrack.org/) | `scaffold` | 75 | P1 | Component / vuln correlation |
| `cave-scan` | ✓ | SonarQube | [link](https://www.sonarsource.com/products/sonarqube/) | `scaffold` | 75 | P2 | Code-quality UI |
| `cave-scheduler` | ✓ | Kubernetes Dashboard (scheduling) | [link](https://github.com/kubernetes/dashboard) | `partial` | 214 | P0 | Scheduler queue, predicates, priorities |
| `cave-search` | ✓ | OpenSearch Dashboards | [link](https://opensearch.org/docs/) | `scaffold` | 75 | P1 | Discover, visualize |
...
| `cave-store` | ✓ | MinIO Console | [link](https://min.io/docs/minio/linux/operations/minio-console.html) | `scaffold` | 75 | P1 | Bucket browser |
| `cave-streams` | ✓ | AKHQ / kafdrop (external) | [link](https://akhq.io/) | `partial` | 293 | P1 | Kafka topic browser |
