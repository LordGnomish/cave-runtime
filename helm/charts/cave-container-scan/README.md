...
Helm chart for **cave-container-scan** — port of Trivy v0.70.0.
...
```bash
helm install my-container-scan ./helm/charts/cave-container-scan \
...
| Key | Default | Notes |
| --- | --- | --- |
| `image.repository` | `ghcr.io/lordgnomish/cave-container-scan` | OCI image (placeholder until release pipeline lands) |
...
```bash
helm upgrade my-container-scan ./helm/charts/cave-container-scan \
...
```bash
helm test my-container-scan --namespace cave-system
```
