...
pub const ADR_LINKS: &[(&str, &[&str])] = &[
    ...
    ("etcd-io/etcd",                     &["ADR-RUNTIME-PERSISTENCE-CONSOLIDATION-001"]),
    ("kubernetes/kubernetes",            &["ADR-RUNTIME-STACK-001", "ADR-003"]),
    ...
    ("istio/istio",                      &["ADR-004"]),
    ("Kong/kong",                        &["ADR-027", "ADR-RUNTIME-API-GATEWAY-CONSOLIDATION-001"]),
    ("coredns/coredns",                  &["ADR-024"]),
    // ── Auth / identity / secrets ──────────────────────────────────────────
    ("keycloak/keycloak",                &["ADR-006", "ADR-PORTAL-AUTH-001", "ADR-PORTAL-PERSONAS-001"]),
    ...
    // ── Data layer ────────────────────────────────────────────────────────
    ("cloudnative-pg/cloudnative-pg",    &["ADR-RUNTIME-PERSISTENCE-CONSOLIDATION-001"]),
    ("minio/minio",                      &["ADR-DATA-LAKE-PATTERN-001"]),
    ("strimzi/strimzi-kafka-operator",   &["ADR-021", "ADR-RUNTIME-STREAMING-CONSOLIDATION-001"]),
    ("apache/kafka",                     &["ADR-021", "ADR-RUNTIME-STREAMING-CONSOLIDATION-001"]),
    ...
    ("cert-manager/cert-manager",        &["ADR-015", "ADR-RUNTIME-CERT-LIFECYCLE-001"]),
