            ...
            spec: TaskSpec {
                ...
                params: vec![
                    ...
                    ParamSpec {
                        ...
                        param_type: ParamType::String,
                        description: Some("Branch/tag/SHA".to_string()),
                        default: Some(ParamValue::String("main".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "depth".to_string(),
                        param_type: ParamType::String,
                        description: Some("Clone depth (0=full)".to_string()),
                        default: Some(ParamValue::String("1".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "submodules".to_string(),
                        param_type: ParamType::String,
                        description: Some("Fetch submodules".to_string()),
                        default: Some(ParamValue::String("true".to_string())),
                        enum_values: None,
                    },
                ],
                workspaces: vec![
                    WorkspaceDeclaration {
                        ...
                        description: Some("Workspace for the cloned repo".to_string()),
                        optional: false,
                        mount_path: None,
                        read_only: false,
                    },
                    WorkspaceDeclaration {
                        name: "ssh-directory".to_string(),
                        description: Some("SSH credentials".to_string()),
                        optional: true,
                        mount_path: Some("/root/.ssh".to_string()),
                        read_only: true,
                    },
                    WorkspaceDeclaration {
                        name: "basic-auth".to_string(),
                        description: Some("HTTP basic auth credentials".to_string()),
                        optional: true,
                        mount_path: None,
                        read_only: true,
                    },
                ...
                results: vec![
                    ResultSpec {
                        ...
                        description: Some("The SHA of the cloned commit".to_string()),
                        result_type: ParamType::String,
                    },
                    ResultSpec {
                        name: "url".to_string(),
                        description: Some("The URL of the cloned repo".to_string()),
                        result_type: ParamType::String,
                    },
                    ResultSpec {
                        name: "committer-date".to_string(),
                        description: Some("Date of the HEAD commit".to_string()),
                        result_type: ParamType::String,
                    },
                ],
                steps: vec![Step {
                    ...
                    env: vec![
                        EnvVar {
                            name: "PARAM_URL".to_string(),
                            value: Some("$(params.url)".to_string()),
                            value_from: None,
                        },
                        EnvVar {
                            name: "PARAM_REVISION".to_string(),
                            value: Some("$(params.revision)".to_string()),
                            value_from: None,
                        },
                        EnvVar {
                            name: "PARAM_DEPTH".to_string(),
                            value: Some("$(params.depth)".to_string()),
                            value_from: None,
                        },
                    ],
                    volume_mounts: vec![VolumeMount {
                        name: "output".to_string(),
                        mount_path: "/workspace/output".to_string(),
                        sub_path: None,
                        read_only: false,
                    }],
                    script: Some(
            ...
            spec: TaskSpec {
                ...
                params: vec![
                    ParamSpec {
                        ...
                        param_type: ParamType::String,
                        description: Some(
                            "Reference of the image buildah will produce.".to_string(),
                        ),
                        default: None,
                        enum_values: None,
                    },
                    ParamSpec {
                        ...
                        default: Some(ParamValue::String("./Dockerfile".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "CONTEXT".to_string(),
                        param_type: ParamType::String,
                        description: Some("Path to the directory to use as context.".to_string()),
                        default: Some(ParamValue::String(".".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "TLSVERIFY".to_string(),
                        param_type: ParamType::String,
                        description: Some("Verify the TLS on the registry endpoint.".to_string()),
                        default: Some(ParamValue::String("true".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "BUILD_EXTRA_ARGS".to_string(),
                        param_type: ParamType::String,
                        description: Some(
                            "Extra parameters passed for the build command.".to_string(),
                        ),
                        default: Some(ParamValue::String("".to_string())),
                        enum_values: None,
                    },
                ...
                workspaces: vec![
                    WorkspaceDeclaration {
                        ...
                        description: Some("Workspace containing the source code.".to_string()),
                        optional: false,
                        mount_path: None,
                        read_only: false,
                    },
                    WorkspaceDeclaration {
                        ...
                        description: Some("Docker credentials.".to_string()),
                        optional: true,
                        mount_path: Some("/root/.docker".to_string()),
                        read_only: true,
                    },
                ],
                results: vec![
                    ResultSpec {
                        name: "IMAGE_DIGEST".to_string(),
                        description: Some("Digest of the image just built.".to_string()),
                        result_type: ParamType::String,
                    },
                    ResultSpec {
                        name: "IMAGE_URL".to_string(),
                        description: Some("URL of the image just built.".to_string()),
                        result_type: ParamType::String,
                    },
                ],
                steps: vec![Step {
            ...
            spec: TaskSpec {
                ...
                params: vec![
                    ParamSpec {
                        ...
                        param_type: ParamType::String,
                        description: Some("Helm release name.".to_string()),
                        default: None,
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "release_namespace".to_string(),
                        param_type: ParamType::String,
                        description: Some("Namespace to deploy to.".to_string()),
                        default: Some(ParamValue::String("default".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "charts_dir".to_string(),
                        param_type: ParamType::String,
                        description: Some("Path to the chart directory.".to_string()),
                        default: Some(ParamValue::String("./helm".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "values_file".to_string(),
                        param_type: ParamType::String,
                        description: Some("Path to values file.".to_string()),
                        default: Some(ParamValue::String("values.yaml".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "wait".to_string(),
                        param_type: ParamType::String,
                        description: Some("Wait for rollout.".to_string()),
                        default: Some(ParamValue::String("true".to_string())),
                        enum_values: None,
                    },
                ],
                workspaces: vec![
                    ...
                    WorkspaceDeclaration {
                        ...
                        description: Some("Kubeconfig for cluster access.".to_string()),
                        optional: true,
                        mount_path: Some("/root/.kube".to_string()),
                        read_only: true,
                    },
                ],
                results: vec![],
...
"#
            ...
            spec: TaskSpec {
                ...
                params: vec![
                    ParamSpec {
                        name: "IMAGE".to_string(),
                        param_type: ParamType::String,
                        description: Some("Image to scan.".to_string()),
                        default: None,
                        enum_values: None,
                    },
                    ParamSpec {
                        ...
                        param_type: ParamType::String,
                        description: Some("Severity levels to report.".to_string()),
                        default: Some(ParamValue::String("HIGH,CRITICAL".to_string())),
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "EXIT_CODE".to_string(),
                        param_type: ParamType::String,
                        description: Some("Exit code on vuln found.".to_string()),
                        default: Some(ParamValue::String("0".to_string())),
                        enum_values: None,
                    },
                ],
                workspaces: vec![],
                results: vec![ResultSpec {
                    ...
                    description: Some("Trivy scan output summary.".to_string()),
                    result_type: ParamType::String,
                }],
                steps: vec![Step {
        ...
        CatalogEntry {
            ...
            spec: TaskSpec {
                ...
                params: vec![
                    ParamSpec {
                        name: "SONAR_HOST_URL".to_string(),
                        param_type: ParamType::String,
                        description: Some("SonarQube server URL.".to_string()),
                        default: None,
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "SONAR_PROJECT_KEY".to_string(),
                        param_type: ParamType::String,
                        description: Some("Project key.".to_string()),
                        default: None,
                        enum_values: None,
                    },
                    ParamSpec {
                        name: "SOURCE_TO_SCAN".to_string(),
                        param_type: ParamType::String,
                        description: Some("Source path to scan.".to_string()),
                        default: Some(ParamValue::String(".".to_string())),
                        enum_values: None,
                    },
                ],
                ...
                steps: vec![Step {
                    ...
                    env: vec![EnvVar {
                        name: "SONAR_TOKEN".to_string(),
                        value: None,
                        value_from: Some(EnvVarSource::SecretKeyRef {
                            name: "sonar-secret".to_string(),
                            key: "token".to_string(),
                        }),
                    }],
                    volume_mounts: vec![],
