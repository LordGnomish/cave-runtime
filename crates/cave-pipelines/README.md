...
CI/CD pipeline engine — compatible with Tekton + Jenkins
...
- [tektoncd/pipeline](https://github.com/tektoncd/pipeline) — `Tekton Pipelines` (License: Apache-2.0), tracked at version `v0.55.0`.
