...
GitOps deployment engine — compatible with ArgoCD + Flux

## Status

Tracked by `parity.manifest.toml`. Current fill ratio: **0.9737** (honest: 0.6316). Tier **C**.

## Upstream

- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) — `Argo CD` (License: Apache-2.0), tracked at version `v3.4.2`.
