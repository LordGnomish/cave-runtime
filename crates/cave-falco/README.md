...
Falco runtime-security userspace surface — rule engine, k8s_audit, output sidekick, plugin SDK (kernel-out-of-process per ADR-RUNTIME-SANDBOX-NO-FFI-001)

## Status

Tracked by `parity.manifest.toml`. Current fill ratio: **1.0000** (honest: 0.7308). Tier **C**.
