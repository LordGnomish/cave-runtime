...
impl Metrics {
    pub fn new(registry: &mut Registry) -> Arc<Self> {
        ...
        registry.register(
            ...
            "Total proposals received",
            m.proposals_total.clone(),
        );
        registry.register(
            "raft_proposals_failed",
            "Failed proposals",
            m.proposals_failed.clone(),
        );
        registry.register(
            "raft_elections_started",
            "Elections started",
            m.elections_started.clone(),
        );
        registry.register(
            "raft_leader_changes",
            "Leadership transitions",
            m.leader_changes.clone(),
        );
        registry.register(
            "raft_heartbeats_sent",
            "Heartbeats sent",
            m.heartbeats_sent.clone(),
        );
        registry.register(
            "raft_append_entries_sent",
            "AppendEntries RPCs sent",
            m.append_entries_sent.clone(),
        );
        registry.register(
            "raft_snapshots_sent",
            "Snapshots sent",
            m.snapshots_sent.clone(),
        );
        registry.register(
            "raft_snapshots_received",
            "Snapshots received",
            m.snapshots_received.clone(),
        );
        registry.register(
            "raft_entries_applied",
            "Entries applied to state machine",
            m.entries_applied.clone(),
        );
        registry.register(
            "raft_log_compactions",
            "Log compactions performed",
            m.log_compactions.clone(),
        );
        registry.register(
            "raft_check_quorum_failures",
            "Check-quorum step-downs",
            m.check_quorum_failures.clone(),
        );
        registry.register(
            "raft_membership_changes",
            "Membership changes",
            m.membership_changes.clone(),
        );
        registry.register(
            "raft_dr_lag_entries",
            "DR replication lag in entries",
            m.dr_lag_entries.clone(),
        );
        registry.register(
            "raft_read_index_requests",
            "ReadIndex requests",
            m.read_index_requests.clone(),
        );
        m
    }
}
