...
Secret scanner — Gitleaks-parity rule engine (regex + entropy + allowlist), JSON/SARIF reporters, git-history walker

## Status

Tracked by `parity.manifest.toml`. Current fill ratio: **1.0000** (honest: 0.9000). Tier **C**.

## Upstream

- [gitleaks/gitleaks](https://github.com/gitleaks/gitleaks) (License: MIT), tracked at version `v8.29.1`.
