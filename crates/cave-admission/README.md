...
Admission controller — compatible with Kyverno + Gatekeeper
...
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) (License: Apache-2.0), tracked at version `v1.28.0`.
