...
Permission framework — compatible with Backstage permission-backend
...
- [casbin/casbin](https://github.com/casbin/casbin) (License: Apache-2.0), tracked at version `v3.10.0`.
