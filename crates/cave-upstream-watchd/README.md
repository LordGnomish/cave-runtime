...
Upstream release watch daemon — polls GitHub for new releases, detects parity gaps, emits GAP_OPENED events. Charter self-healing/self-improving foundation.
