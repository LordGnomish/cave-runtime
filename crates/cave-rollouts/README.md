...
Progressive delivery engine — compatible with Flagger + Argo Rollouts

## Status

Tracked by `parity.manifest.toml`. Current fill ratio: **0.9677** (honest: 0.7097). Tier **C**.

## Upstream

- [argoproj/argo-rollouts](https://github.com/argoproj/argo-rollouts) — `Argo Rollouts` (License: Apache-2.0), tracked at version `v1.9.0`.
