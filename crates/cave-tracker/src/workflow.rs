    ...
    Workflow {
        ...
        statuses: vec![
            WorkflowStatus {
                ...
                description: "Not yet in a sprint".to_string(),
            },
            WorkflowStatus {
                name: "To Do".to_string(),
                category: StatusCategory::Todo,
                description: "In sprint, not started".to_string(),
            },
            WorkflowStatus {
            ...
            WorkflowStatus {
                ...
                category: StatusCategory::InProgress,
                description: "Under code review".to_string(),
            },
            WorkflowStatus {
                name: "Done".to_string(),
        ...
        transitions: vec![
            ...
            Transition {
                ...
                post_functions: vec![
                    PostFunction::SetResolution("Fixed".to_string()),
                    PostFunction::NotifyWatchers,
                ],
            },
            Transition {
                id: "reopen".to_string(),
                ...
                conditions: vec![],
                validators: vec![],
                post_functions: vec![PostFunction::SetField {
    ...
    Workflow {
        ...
        statuses: vec![
            WorkflowStatus {
                name: "To Do".to_string(),
                category: StatusCategory::Todo,
                description: "Ready to start".to_string(),
            },
            WorkflowStatus {
                name: "In Progress".to_string(),
                category: StatusCategory::InProgress,
...
pub fn available_transitions<'a>(workflow: &'a Workflow, from_status: &str) -> Vec<&'a Transition> {
    workflow
        .transitions
        .iter()
        .filter(|t| t.from_status.is_empty() || t.from_status.iter().any(|s| s == from_status))
        .collect()
}
...
pub fn apply_transition(issue: &mut crate::models::Issue, transition: &Transition) {
    ...
    for pf in &transition.post_functions {
        match pf {
            PostFunction::SetResolution(res) => {
                issue.resolution = Some(res.clone());
            }
            ...
            PostFunction::NotifyWatchers
            | PostFunction::NotifyAssignee
            | PostFunction::ClearAssignee => {}
        }
    }
