...
Runtime security — Falco rule engine + Trivy vulnerability scanner
...
- [falcosecurity/falco](https://github.com/falcosecurity/falco) (License: Apache-2.0), tracked at version `v0.36.0`.
