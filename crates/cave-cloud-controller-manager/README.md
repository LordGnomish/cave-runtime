...
Cloud-controller-manager parity scaffold (cloud-provider trait, node / service / route controllers, Hetzner + Azure provider basics)

## Status

Tracked by `parity.manifest.toml`. Current fill ratio: **1.0000** (honest: 0.9565). Tier **A**.
