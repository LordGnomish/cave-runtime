...
Technical documentation hosting — compatible with Backstage TechDocs
...
- [backstage/backstage](https://github.com/backstage/backstage) (License: Apache-2.0), tracked at version `v1.50.4`.
