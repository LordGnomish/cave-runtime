...
Config & image linting — compatible with Hadolint + Checkov + Pluto + kubent
...
- [SonarSource/sonarqube](https://github.com/SonarSource/sonarqube) (License: LGPL-3.0), tracked at version `v10.3.0`.
