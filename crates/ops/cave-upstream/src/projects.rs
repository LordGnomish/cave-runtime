...
pub const TRACKED_PROJECTS: &[TrackedProject] = &[
    ...
    TrackedProject {
        ...
        cave_module: "cave-rag",
        track_features: "document loaders, text splitters, retrievers, generation chains",
        check_frequency: "weekly",
        category: "ai",
        phase: 2,
    },
    TrackedProject {
        ...
        cave_module: "cave-rag",
        track_features: "indexing, query engines, node postprocessors, semantic splitting",
        check_frequency: "weekly",
        category: "ai",
        phase: 2,
    },
    TrackedProject {
        ...
        cave_module: "cave-rag",
        track_features: "knowledge-graph extraction, communities, local/global search",
        check_frequency: "weekly",
        category: "ai",
        phase: 2,
    },
    TrackedProject {
        ...
        cave_module: "cave-rag",
        track_features: "pipeline component model, rerankers, agentic RAG loops",
        check_frequency: "weekly",
        category: "ai",
        phase: 2,
    },
