...
// Source: goharbor/harbor@c80058d52f555c9bd4552ea14c9d3e73ba0e4b12 src/pkg/scan/job.go + src/pkg/scan/controller.go
...
use crate::harbor::proxy::{Ecosystem, FetchedArtifact};
use bytes::Bytes;
