...
// Source: goharbor/harbor@c80058d52f555c9bd4552ea14c9d3e73ba0e4b12 src/pkg/policy/retention/manager.go + src/pkg/quota/manager.go
//! Tag immutability policies and repository-level access control.

use crate::harbor::store::RegistryStore;
use crate::harbor::types::{AccessRule, Permission, TagPolicy};
use std::sync::Arc;
