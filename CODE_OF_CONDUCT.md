...
> Contributor Covenant v2.1'den uyarlanmıştır.
...
*Topluluğumuza üye, katkıda bulunan ve lider olarak; yaş, beden boyutu,
görünür veya görünmez engellilik, etnik köken, cinsiyet özellikleri,
cinsiyet kimliği ve ifadesi, deneyim düzeyi, eğitim, sosyo-ekonomik
durum, milliyet, kişisel görünüm, ırk, sınıf, renk, din veya cinsel
kimlik ve yönelimden bağımsız olarak herkese tacizden uzak bir katılım
deneyimi sunacağımıza söz veriyoruz.*
...
public spaces. Examples include using an official e-mail address,
...
- GitHub: open a private security advisory at
  ...
  (the same channel as security disclosures; the maintainer triages both).
- Email: **conduct@cave-runtime.dev** (alias forwarded to the project
  maintainer; PGP key published at `/.well-known/security.txt` once the
  public site is live).
